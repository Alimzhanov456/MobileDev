...
public class MyApplication extends Application {
    ...
    private static void saveDownloadedBook(Context context, ProgressDialog progressDialog, byte[] bytes, String nameWithExtension, String bookId) {
        ...
        try {
            ...
            Toast.makeText(context, "saveDownloadedBook: Failed saving to Download Folder due to"+e.getMessage(), Toast.LENGTH_SHORT).show();
            progressDialog.dismiss();
        }
    }
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        reference.child(bookId).updateChildren(hashMap)
                                ...
                                .addOnFailureListener(new OnFailureListener() {
                                    @Override
                                    public void onFailure(@NonNull Exception e) {
                                        Log.d(TAG_DOWNLOAD, "onFailure: Failed to updated Downloads Count due to "+e.getMessage());
                                    }
                                });
